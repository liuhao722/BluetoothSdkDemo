 ...
 */
@Deprecated(message = "废弃该方式")
internal class PadSdkHelper2 private constructor() {
     ...
     * 设置使用设备的类型
     */
    fun setPhoneType(isPad: Boolean = true): PadSdkHelper2 {
     ...
     * 设置macId
     */
    fun setMacId(macId: String?): PadSdkHelper2 {
